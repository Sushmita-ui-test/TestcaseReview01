...
public class Testcase101 {
	...
	//	WebDriver driver = new FirefoxDriver();
		//For my system setting up the property file
		System.setProperty("webdriver.chrome.driver", "C:\\Program Files\\Mozilla Firefox");
		WebDriver driver = new FirefoxDriver();
	    ...
	    //  Thread.sleep(3000);
	    //Instaed of Thread.sleep we can use WebDriverWait
	    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//td[@class ='lt-cell align-center hf-mod-no-padding ember-view']")));
	     ...
	     // Thread.sleep(9000);
	      //Similarly for this wait as well
	      WebDriverWait wait1 = new WebDriverWait(driver, Duration.ofSeconds(10));
	        wait1.until(ExpectedConditions.elementToBeClickable(By.xpath("//td[@class ='lt-cell align-center hf-mod-no-padding ember-view']")));
      ...
      //    Thread.sleep(9000);
          ...
          WebDriverWait wait2 = new WebDriverWait(driver, Duration.ofSeconds(10));
	        wait2.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button[data-test-id='add-priority']")));
         ...
         // Thread.sleep(9000);
          ...
          WebDriverWait wait3 = new WebDriverWait(driver, Duration.ofSeconds(10));
	        wait3.until(ExpectedConditions.elementToBeClickable(By.cssSelector("button[data-test-id='delete-dependants-primary-action']")));
...
// Same page cannot have two main methods, we have to create instances of the page or have to create different pages and extend that class in the main method
  ...
  /*   public static void main(String[] args) {
	  ...
	  public void performHappyFoxTasks(WebDriver driver) {
	        driver.get("https://www.happyfox.com");
